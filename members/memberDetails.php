...
if (($_COOKIE['memberID'] != "") && (isset($HTTP_GET_VARS['removeShow']))) {
  $deleteSQL = sprintf("DELETE FROM 58_memberShows WHERE showID='".$HTTP_GET_VARS['removeShow']."' AND memberID='".$_COOKIE['memberID']."'");
...
<tr><td width="688" background="../images/58hrs_header_taller.jpg" bgcolor="#FFFFFF"><img src="../images/pixelshim.gif" width="20" height="150" />
  ...
  <td width="108" align="right" bgcolor="#000000"><?php include('../loginModule.php') or die("unable to open Member Module"); ?>
  </td>
          ...
          <tr> 
            <td width="300" height="72" valign="top">              <font color="#CCCCCC" size="1" face="Arial, Helvetica, sans-serif">&nbsp;              </font>
              <table width="300" border="0" cellspacing="1" cellpadding="2">
                ...
                <tr>
                  <td nowrap="nowrap"><span class="style1">member URL: </span></td>
                  <td nowrap="nowrap"><span class="style1"><?php echo $row_memberName['pn_url']; ?></span></td>
                </tr>
                <tr>
                  <td nowrap="nowrap">&nbsp;</td>
                  <td nowrap="nowrap">&nbsp;</td>
                ...
                <tr>
                  <td colspan="2" align="center" nowrap="nowrap"><a href="#">[edit member profile]</a></td>
                  </tr>
              </table>
              <p><br />
                </p>
            ...
            <td align="right" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr>
                  <th colspan="3" bgcolor="#FFFFFF"><span class="style4">Shows
                      attended : <?php echo $totalRows_claimedShows ?></span> </th>
                </tr>
                <?php do { ?>
                <tr>
                    <td width="41%"><?php echo $row_claimedShows['showDate']; ?></td>
                    <td width="42%" nowrap="nowrap"><a href="/58_displayshow.php?showID=<?php echo $row_claimedShows['showID']; ?>"><?php echo $row_claimedShows['venueName']; ?></a> (<?php echo $row_claimedShows['showID']; ?>)</td>
                ...
                <tr>
                  <td colspan="3"><div align="center"><span class="style1">View your personal performance numbers. </span></div></td>
                </tr>
              </table>
