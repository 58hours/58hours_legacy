...
echo "{\"response\":{\"method\":\"getSongPerformanceHistory\",\"status\":\"success\",";
echo "\"songDetails\":{\"title\":\"".$row_trackDetails['trackTitle']."\",\"id\":\"".$row_trackDetails['trackID']."\",\"sysID\":\"".$row_trackDetails['f8_song_id']."\",";
echo "\"artist\":{\"id\":\"00sah5JHs_\",\"artistName\":\"Radiohead\"},";
echo "\"ocdstats\":{\"grandtotal\":\"".$totalRows_totalTimes."\",\"open\":\"".$totalRows_openingtracks."\",\"encore1\":\"".$totalRows_encoreLead."\",\"encore2\":\"".$totalRows_encore2Lead."\",\"avgpos\":\"".$row_posVariance['avgPos']."\"},";
echo "\"yearbreakdown\":{";
echo "\"year\":[{\"value\":\"2000\",\"num\":\"".$row_perfs2000['COUNT(*)']."\"},";
echo "{\"value\":\"2001\",\"num\":\"".$row_perfs2001['COUNT(*)']."\"},";
echo "{\"value\":\"2002\",\"num\":\"".$row_perfs2002['COUNT(*)']."\"},";
echo "{\"value\":\"2003\",\"num\":\"".$row_perfs2003['COUNT(*)']."\"},";
echo "{\"value\":\"2004\",\"num\":\"".$row_perfs2004['COUNT(*)']."\"}]";
echo "},";
echo "\"lifespan\":{";
echo "\"performance\":[";

echo "{\"type\":\"0\",\"id\":\"".$row_wooHoo['showID']."\",\"showdate\":\"".date('l, m/d/Y',strtotime($row_wooHoo['showDate']))."\",";
echo "\"geoloc\":{\"ve\":{\"id\":\"\",\"name\":\"".$row_wooHoo['venueName']."\"},";
echo "\"ci\":{\"id\":\"\",\"name\":\"".$row_wooHoo['cityName']."\"},";
echo "\"lo\":{\"id\":\"\",\"name\":\"".$row_wooHoo['localityName']."\"},";
echo "\"co\":{\"id\":\"\",\"name\":\"".$row_wooHoo['countryName']."\"}";
echo "}},";

echo "{\"type\":\"1\",\"id\":\"".$row_hooWoo['showID']."\",\"showdate\":\"".date('l, m/d/Y',strtotime($row_hooWoo['showDate']))."\",";
echo "\"geoloc\":{\"ve\":{\"id\":\"\",\"name\":\"".$row_hooWoo['venueName']."\"},";
echo "\"ci\":{\"id\":\"\",\"name\":\"".$row_hooWoo['cityName']."\"},";
echo "\"lo\":{\"id\":\"\",\"name\":\"".$row_hooWoo['localityName']."\"},";
echo "\"co\":{\"id\":\"\",\"name\":\"".$row_hooWoo['countryName']."\"}";
echo "}}]";
echo "},";
...
do
{
	echo "{\"id\":\"".$row_perfCollection['showID']."\",\"date\":\"".date('l, m/d/Y',strtotime($row_perfCollection['showDate']))."\",";
	echo '"geoprop":[';
	echo '{"type":"ve","id":"'.$row_perfCollection['venueID'].'","name":"'.$row_perfCollection['venueName'].'"},';
	echo '{"type":"ci","id":"'.$row_perfCollection['cityID'].'","name":"'.$row_perfCollection['cityName'].'"},';
	echo '{"type":"lo","id":"'.$row_perfCollection['localityID'].'","name":"'.$row_perfCollection['localityName'].'"},';
	echo '{"type":"co","id":"'.$row_perfCollection['countryID'].'","name":"'.$row_perfCollection['countryName'].'"';
	echo "}]},";
}while ($row_perfCollection = mysql_fetch_assoc($perfCollection));
echo "\"eof\"]},";
echo '"studioreleases":[';
do{
	echo "{\"title\":\"".$row_versionTitles['releaseTitle']."\",\"releasedate\":\"".$row_versionTitles['releaseDate']."\",\"country\":\"".$row_versionTitles['country']."\",\"versionName\":\"".$row_versionTitles['releaseTitle']."\"},";
