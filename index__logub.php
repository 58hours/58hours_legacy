...
<tr><td><div align="center">
  <table width="800" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td align="center" bgcolor="#FFFFFF"><img src="images/rainbowsheader.jpg" alt="New album from Radiohead. LP7. In Rainbows" border="0" width="800" height="361"><br />
    ...
    <tr> 
      <td bgcolor="#FFFFFF"><font color="#999999">&nbsp; </font>
        <table width="800" border="0" cellspacing="0" cellpadding="5" valign="top">
          <tr>
            <td>
            <table width="100%"  border="0" cellpadding="1" cellspacing="0" bgcolor="#CCCCCC" valign="top">
              <tr>
                <td width="75%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                  <tr>
                    <td><font size="1" face="Arial, Helvetica, sans-serif" class="mainBodyText">
                ...
                <td width="25%" rowspan="2" valign="top"><table width="204"  border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <div align="left"><font color="#999999" size="1" face="Arial, Helvetica, sans-serif" class="mainBodyText"><?php require_once('loginModule_flash.php'); ?></font></div>
                    <p><font size="1" face="Arial, Helvetica, sans-serif" class="mainBodyText">Why register?</font></p>
                    <p><font size="1" face="Arial, Helvetica, sans-serif" class="mainBodyText">Currently members can track which shows they've been to. </font></p>
                    <p><font size="1" face="Arial, Helvetica, sans-serif" class="mainBodyText">Additionally (eventually) all members will soon be able to upload their pictures from shows, post show reviews, track their own Radiohead tour/song stats, and see a significant increase of their overall swankness factor.</font></p>
                    <p><font face="Arial, Helvetica, sans-serif" class="mainBodyText">enjoy the info,<br />
                    </font><font size="1" face="Arial, Helvetica, sans-serif" class="mainBodyText">-brian</font>
	                      </p>
						  <font size="1" face="Arial, Helvetica, sans-serif">Still alive here, still working on getting the login functionality working again for y'all... New North American tour cities have been announced for 2008 (no dates or venues as of yet)  We'll let you know as we hear.<br />
						  best,<br />brian.</font>
                    </td>
                  </tr>
                </table></td>
              ...
              <tr>
                <td valign="top"><table width="500" border="0" cellspacing="0" cellpadding="2" valign="top">
                  <tr>
                    ...
                    <img src="/images/pixelshim.gif" width="585" height="1" /><font size="1" face="Arial, Helvetica, sans-serif"><img src="images/58_mainBrowse.gif" width="200" height="22" /><br />
                      </font>
...
?>
                        ...
                        <?php } // Show if recordset not empty ?>
                        <br />
                        <a href="./tour_details.php?tour=10">[CURRENT TOUR NUMBERS]</a><br />
...
Welcome to 58hours:<br />
      &nbsp; It's a Radiohead gig database. A gigography of sorts... (whatever you want to label it) but in essence - a Radiohead Setlist Database. Seen a show? Look it up... check the info, and look through the setlist... hell... write a review. If you should find any problems, or have any qualms or questions just <a href="#" onClick="MM_openBrWindow('post_comments.php?commentCat=site','siteComments','status=yes,width=450,height=300')">drop me a line...</a>  </span></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
